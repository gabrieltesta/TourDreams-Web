      ...
      <div class="inferiorEsquerda">
        <div class="tiraVisaoMissaoValores">
          ...
          <div class="conteudo">
            <h3>Missão</h3>
            <p>
            Nossa empresa quando seu criador percebeu a falta
            de empresas fornecedoras de serviços de viagens que
             possuiam um tratamento próximo, pessoal e personalizado
              com seus clientes, e focavam apenas na reserva em si.
              Em 2010 foi fundada a TourDreams com esses conceitos
               em mente, procurando ligar os parceiros fornecedores
                com os clientes, garantindo um excelente atendimento
                 de intermédio para conquistar o mercado que sente
                  tanta falta deste serviço.
            </p>
          </div>
        </div>
        <div class="tiraVisaoMissaoValores">
          ...
          <div class="conteudo">
            <h3>Visão</h3>
            <p>
              A TourDreams deseja ser a 1ª empresa brasileira em
             reservas de viagens até o ano de 2020, ano que completa
              10 anos de existência, melhorando ainda mais seus
              serviços para garantir um serviço cada vez melhor
             para seus clientes.Deseja também aumentar seu raio
              de serviços para criar um portal completo de viagens,
              com tudo que você possa precisar ao planejar uma viagem.
            </p>
          </div>
        </div>
        <div class="tiraVisaoMissaoValores">
          ...
          <div class="conteudo">
            <h3>Valores</h3>
            <p>
            A TourDreams possui diversos valores que todos seus
            funcionários seguem.Devem demonstrar e garantir
            honestidade, integridade aos nossos clientes, de forma
             clara, precisa e consistente, criando uma relação
              saudável e de respeito entre nossos clientes,
              funcionários e a empresa em si.
            </p>
          </div>
        </div>
      </div>
